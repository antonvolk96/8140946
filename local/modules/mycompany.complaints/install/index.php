...
Битрикс CModule*/
Class mycompany_complaints extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "mycompany.complaints";
    var $MODULE_ID = "mycompany.complaints";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("mycompany.complaints_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("mycompany.complaints_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("mycompany.complaints_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("mycompany.complaints_PARTNER_URI");
    }
